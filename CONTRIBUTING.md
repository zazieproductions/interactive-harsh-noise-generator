...
Documentation is a first-class deliverable. If you change behavior, update the docs:
...
Write code that a future you (or a recruiter, or a fellow noise nerd) will read and think,
